...
<div class="container" style="max-width: 860px; background-color: white;">
  ...
  <p class="content-text">
    Temporal Action Localization (TAL) is a complex task that poses relevant challenges, particularly when attempting to generalize on new—unseen—domains in real-world applications. These scenarios, despite being realistic, are often neglected in the literature, exposing existing solutions to important performance degradation. In this work, we tackle this issue by introducing <strong>Semantic Adversarial unsupervised Domain Adaptation (SADA)</strong>. Our approach pioneers UDA for sparse action detection by introducing a novel adversarial loss sensitive to local class distributions. We evaluate SADA on a new suite of benchmarks based on EpicKitchens-100, attaining a relative performance boost of up to 14%.
  </p>
